...
## Problema
Hoy el gate se corre a mano; sin cadencia, la deriva de SANO→VIGILAR pasa desapercibida.

## Criterios de aceptación (la suite los verifica)
1. **`ci_gate.py`** (stdlib puro) en la raíz del kit: corre `gate/run_gate.py` (fixtures limpias Y rotas) **y**
